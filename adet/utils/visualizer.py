...
class TextVisualizer(Visualizer):
    ...
    def overlay_instances(self, beziers, recs, scores, alpha=0.15):
        color = (0., 1.0, 0.)
        ...
        for bezier, rec, score in zip(beziers, recs, scores):
            ...
            lighter_color = self._change_color_brightness(color, brightness_factor=-0.75)
            text_pos = polygon[0]
            horiz_align = "left"
            ...
            self.draw_text(
                ...
                draw_chinese=False if self.voc_size == 230 else True
            )
        ...
        *,
        ...
        if draw_chinese:
            ...
            self.output.ax.text(
                ...
                family="sans-serif",
                bbox={"facecolor": "white", "alpha": 0.7, "pad": 2.0, "edgecolor": "none"},
