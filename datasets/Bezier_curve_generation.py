...
labels = glob.glob('/mmlabworkspace/WorkSpaces/danhnt/tuyensh/tungphan/AIC/VN-ABINet/datasets/becan_gen_labels/*.txt')
# print(labels)
# labels.sort()
...
for il, label in enumerate(labels):
    print('Pros '+label)
    imgdir = label.replace('becan_gen_labels/', 'ctwtrain_text_image/').replace('.txt', '.jpg')
    ...
    for iid, ddata in enumerate(data):
        ...
        init_control_points = bezier_fitv2(x_data, y_data)
        ...
        init_control_points_b = bezier_fitv2(x_data_b, y_data_b)
        ...
        outstr = '{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{}||||{}\n'.format(x0,y0,\
                                                                            ...
                                                                            round(x3, 1), round(y3, 1),\
                                                                            round(x0_b, 1), round(y0_b, 1),\
                                                                            round(x1_b, 1), round(y1_b, 1),\
                                                                            round(x2_b, 1), round(y2_b, 1),\
                                                                            round(x3_b, 1), round(y3_b, 1),\
                                                                            cts[iid])  
        if(outstr[-4:-1]!="###"):                                                       
          x = open("/mmlabworkspace/WorkSpaces/danhnt/tuyensh/tungphan/AIC/VN-ABINet/datasets/newlabel/"+name+".txt", 'a+')
          x.writelines(outstr)
          x.close()      
    # name += 1
    plt.imshow(img)
